...
<sub> *6 January 2025* I have started as an NLP researcher and engineer at Populytics! Populytics is a spin-off from Delft University of Technology that provides analyses of citizens' opinions about policy dilemmas, setting up experiments within a carefully designed online environment. Populytics works with all kinds of Dutch local and national governments for research projects that offer citizens a direct participation in democratic processes. I use my skills in NLP research and opinion mining to support Populytics's social and political science researchers.
